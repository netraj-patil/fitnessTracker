...
df[['acc_x','acc_y','acc_z',"label"]].boxplot(by = 'label', figsize = (20,10), layout = (1,3))
...
df[['acc_x','acc_y','acc_z',"label"]].plot.hist(by = 'label', figsize = (20,10), layout = (3,3))
df[['gyr_x','gyr_y','gyr_z',"label"]].plot.hist(by = 'label', figsize = (20,10), layout = (3,3))
...
# Loop over all columns
dataset, outliers, X_score = mark_outliers_lof(df, outlier_col)
for col in outlier_col:
...
outlier_remove_df.to_pickle('../../data/interim/02_outliers_removed_chauvenet.pkl')